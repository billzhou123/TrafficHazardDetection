...
QT_MOC_LITERAL(5, 29, 3),
QT_MOC_LITERAL(6, 33, 7)
    },
    "TestThread\0finished\0\0i\0error\0err\0"
    "process"
};
...
void TestThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (TestThread::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TestThread::finished)) {
                *result = 0;
            }
        }
        {
            typedef void (TestThread::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TestThread::error)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject TestThread::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_TestThread.data,
      qt_meta_data_TestThread,  qt_static_metacall, 0, 0}
};
...
// SIGNAL 0
void TestThread::finished(int _t1)
{
...
// SIGNAL 1
void TestThread::error(QString _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
